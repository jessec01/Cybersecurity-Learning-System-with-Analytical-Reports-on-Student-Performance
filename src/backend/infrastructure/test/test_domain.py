...
from backend.domain.entities.roles import Role, Permission
from backend.domain.value_objects.permissions import Permissions, Resource, Action
from backend.domain.errors.auth_errors import UnauthorizedError, ForbiddenError
