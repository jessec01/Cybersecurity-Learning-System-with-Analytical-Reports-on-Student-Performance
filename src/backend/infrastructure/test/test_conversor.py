...
def test_shema_validator_import():
    ...
    try:
        from backend.infrastructure.contracts import shema_validator
...
def _validate_column(table_name, col_name, col_data, table_info):
    ...
    from backend.infrastructure.contracts.shema_validator import (
...
def test_build_table_completo():
    ...
    from backend.infrastructure.contracts.schema_contracts import contract_data
    from backend.infrastructure.contracts.shema_validator import build_table
...
def test_validate_contract_db_import():
    ...
    try:
        from backend.infrastructure.contracts.shema_validator import validate_contract_db
    except Exception as e:
