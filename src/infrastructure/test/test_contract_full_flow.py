...
from infrastructure.contracts.schema_validator import (
...
class TestFullBusinessFlow:
    ...
    def test_seed_roles_and_permissions(self, contract_db):
        ...
        from infrastructure.db.postgres.models import RoleModel, PermissionModel, RolPermissionModel
    ...
    def test_role_repository_with_contract(self, contract_db):
        ...
        from infrastructure.db.postgres.repositories.role_repository import RoleRepository
    ...
    def test_use_case_flow_with_contract(self, contract_db):
        ...
        from application.dto.auth_dto import LoginInput
    ...
    def test_super_admin_flow_with_contract(self, contract_db):
        ...
        from application.dto.auth_dto import SuperAdminLoginInput
        from application.use_cases.auth_use_cases import SuperAdminLoginUseCase
...
class TestContractVsORM:
    ...
    def test_all_contract_tables_have_orm_model(self):
        ...
        from infrastructure.db.postgres import models as orm_models
        contract = load_contract()
